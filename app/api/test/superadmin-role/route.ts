...
export async function POST(request: NextRequest) {
  try {
    ...
    const { fullName, email, phoneNumber, password, profileImage, role } = body;

    console.log('Received data:', { fullName, email, phoneNumber, password: '***', profileImage, role });
    ...
    const superAdminData = {
      ...
      password: password, // Don't hash for testing
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('Retrieved SuperAdmins:', superAdmins);
